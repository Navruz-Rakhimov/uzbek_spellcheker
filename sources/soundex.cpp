...
string Soundex(string input)
{
    ...
    {
        switch (toupper(intermediateResult[i]))
        {
            case 'B':
            case 'F':
            case 'P':
            ...
            case 'D':
            case 'T':
                intermediateResult[i] = '3';
                break;

            case 'L':
                intermediateResult[i] = '4';
                break;

            case 'M':
            case 'N':
                intermediateResult[i] = '5';
                break;

            case 'R':
                intermediateResult[i] = '6';
                break;
    ...
    if (intermediateResult.size() > 4)
    {
        ...
        vector<char>::const_iterator firstElement = intermediateResult.begin();
        vector<char>::const_iterator fourthElement = intermediateResult.begin() + 4;
